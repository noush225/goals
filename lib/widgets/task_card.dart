...
class TaskCard extends StatelessWidget {
  const TaskCard({super.key, required this.task, required this.onPlay});
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _Kicker(isProgression: isProg, minutes: task.minutes),
...
class _Kicker extends StatelessWidget {
  const _Kicker({required this.isProgression, required this.minutes});
